...
const Footer = () => {
    ...
    const navClass = ({ isActive }) =>
        ...
        /* desktop only */
        ${isActive ? "lg:border-b-2 lg:border-white" : ""}
        `;
    ...
    return (
        <footer className="footer footer-horizontal footer-center bg-[#3B4953] text-white  p-10">
                ...
                <div className="grid grid-flow-col gap-4">
                    <a>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            -1.566-.247-2.229-.616-.054 2.281
                            1.581 4.415 3.949 4.89-.693.188
                            -1.452.232-2.224.084.626 1.956
                            2.444 3.379 4.6 3.419-2.07
                            1.623-4.678 2.348-7.29 2.04
                            2.179 1.397 4.768 2.212 7.548
                            2.212 9.142 0 14.307-7.721
                            13.995-14.646.962-.695
                    ...
                    <a>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            -15.23 0-3.897.266-4.356 2.62-4.385
                            8.816.029 6.185.484 8.549
                            4.385 8.816 3.6.245 11.626.246
                            15.23 0 3.897-.266 4.356
                            -2.62 4.385-8.816-.029
                            -6.185-.484-8.549-4.385
                            -8.816zm-10.615 12.816v-8l8
                            3.993-8 4.007z" />
                        </svg>
                    </a>
                    ...
                    <a>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            h3.642l.358-4h-4v-1.667
                            c0-.955.192-1.333 1.115
                            -1.333h2.885v-5h-3.808
                            c-3.596 0-5.192 1.583
                            -5.192 4.615v3.385z" />
                        </svg>
                    </a>
                </div>
